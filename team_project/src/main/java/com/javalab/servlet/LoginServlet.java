...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, 
		...
		// 로그인 폼으로 이동		
		RequestDispatcher rds = request.getRequestDispatcher("/loginForm.jsp");
	...
	protected void doPost(HttpServletRequest request, 
		...
		String url = "/loginForm.jsp";	//로그인 실패시 이동하는 페이지(다시 로그인 페이지)
		...
		Member mb = new Member(id, pw);	// Dao에 인자로 보낼 객체 생성
		
		// 4 사용자 아이디/비밀번호 확인
		Member member = memberDao.loginCheck(mb);
