				...
				function() {
					...
					$.ajax({
						...
						success : function(result) {
							...
							table += '<tr><th>제목</th><td>' + board.title
									+ '</td></tr>';
							table += '<tr><th>작성자</th><td>' + board.id
									+ '</td></tr>';
							table += '<tr><th>내용</th><td>' + board.content
									+ '</td></tr>';
							table += '<tr><th>조회수</th><td>' + board.hit
									+ '</td></tr>';
							table += '<tr><th>작성일</th><td>' + board.regdate
									+ '</td></tr>';
							table += "</table>";
							// 서버에서 받아온 데이터 출력
							$('#output').append(table);
...
<body>
	<form action="" method="get">
		...
		게시물 번호 : <input type="text" name="no" id="no" /><br> <input
			type="button" id="btnSubmit" value="조회" /><br>
		<br>
	</form>
